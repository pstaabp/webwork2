    ...
    <b-container>
      <b-row>
        <b-col offset-md="3" cols="6" class="border p-3 rounded">
          <p>Please enter your login and password for course: {{password_info.course_id}}</p>
          <form @submit.prevent="checkPassword">
            ...
            <b-form-input type="password" id="password" v-model="password_info.password"></b-form-input>
          </b-form-group>
          <b-btn-group>
...
export default class Manager extends Vue {
  private password_info: UserPassword = {course_id: '', user_id: '', password: ''};
