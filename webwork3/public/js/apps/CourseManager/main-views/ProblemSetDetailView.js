    ...
    var DetailsView = TabView.extend({
        ...
        initialize: function (options) {
            ...
            this.calendar.state.on("change",function (){
              self.tabState.set(self.calendar.state.changed);
            });
        },
        render: function(){
            if(this.model){
        ...
        showCalendar: function(_show){
            ...
            // ensure that all of the dates are shown on the calendar
            this.calendar.state.set({open_date: true, reduced_scoring_date: true, due_date: true, answer_date: true});
